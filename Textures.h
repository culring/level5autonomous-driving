...
const std::string ROAD_TEXTURES_DIRECTORY = TEXTURES_DIRECTORY + "Road_test_4.png";
const std::string BACKGROUND_TEXTURE = TEXTURES_DIRECTORY + "ferrari.png";
...
const sf::Rect<int> BACKGROUND_RECTANGLE(0, 0, 1280, 720);
